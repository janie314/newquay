...
for _, grp in ipairs( { "Alternate", "Visible", "Inactive" } ) do
  ...
  vim.api.nvim_set_hl( 0, "Buffer" .. grp .. "Icon",
                       { bg = "#424040", sp = "#424040" } )
  vim.api.nvim_set_hl( 0, "Buffer" .. grp .. "Sign",
                       { bg = "#424040", sp = "#424040" } )
  vim.api.nvim_set_hl( 0, "Buffer" .. grp .. "SignRight",
                       { bg = "#424040", sp = "#424040" } )
end
vim.api.nvim_set_hl( 0, "BufferCurrent", { bg = "#141414", sp = "#141414" } )
vim.api
    .nvim_set_hl( 0, "BufferCurrentIcon", { bg = "#141414", sp = "#141414" } )
